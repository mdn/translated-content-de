...
2. Navigate to [https://github.com/mdn/translated-content-de](https://github.com/mdn/translated-content-de)
...
#### Set up `mdn/translated-content-de` repo

Once that is done, you will also need to fork and clone this repository by following the [upstream Contributing guide](https://github.com/mdn/content/blob/main/CONTRIBUTING.md#forking-and-cloning-the-repository), replacing `content` with `translated-content-de`.
...
2. Next, define an environment variable in a `.env` file called `CONTENT_TRANSLATED_ROOT` containing the path to the _translated-content-de_ repo's `files` directory:

   ```bash
   echo CONTENT_TRANSLATED_ROOT=/path/to/translated-content-de/files >> .env
   ```
...
#### Working in the translated-content-de repo
