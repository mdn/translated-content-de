...
The following is a set of guidelines for contributing to the [translated content of MDN Web Docs](https://github.com/mdn/translated-content-de), which is hosted within the [MDN Organization](https://github.com/mdn) on GitHub.
...
If you want to just find a task and jump in, search by the label `l10n-de` in this repo's [issues list](https://github.com/mdn/translated-content-de/issues), or the main [content repo issues](https://github.com/mdn/content/issues).
