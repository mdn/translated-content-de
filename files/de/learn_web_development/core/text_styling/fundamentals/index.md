...
> [!NOTE]
> Beachten Sie, dass der Text innerhalb eines Elements als eine einzige Einheit behandelt wird. Sie können keine Unterabschnitte des Textes auswählen und stylen, es sei denn, Sie umwickeln sie mit einem geeigneten Element (wie einem {{htmlelement("span")}} oder {{htmlelement("strong")}}), oder verwenden ein textspezifisches Pseudoelement wie [`::first-letter`](/de/docs/Web/CSS/Reference/Selectors/::first-letter) (wählt den ersten Buchstaben des Textes eines Elements aus), [`::first-line`](/de/docs/Web/CSS/Reference/Selectors/::first-line) (wählt die erste Zeile des Textes eines Elements aus), oder [`::selection`](/de/docs/Web/CSS/Reference/Selectors/::selection) (wählt den Text aus, der gerade vom Cursor hervorgehoben wurde).
