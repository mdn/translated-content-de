...
- `same-origin`
  - : Die Anfrage wird vom gleichen Ursprung ausgestellt wie die Ressource, die angefordert wird.
- `websocket`
...
Eine durch ein {{HTMLElement("img")}} Element generierte Cross-Site-Anfrage würde zu einer Anfrage mit den folgenden HTTP-Anforderungsheadern führen (beachten Sie, dass der Modus `no-cors` ist):
