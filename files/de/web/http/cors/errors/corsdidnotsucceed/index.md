...
Die [HTTP](/de/docs/Glossary/HTTP)-Anfrage, die CORS verwendet, ist fehlgeschlagen, weil die HTTP-Verbindung entweder auf Netzwerk- oder Protokollebene fehlschlug. Der Fehler steht nicht direkt im Zusammenhang mit CORS, sondern ist ein grundlegender Netzwerkfehler.
