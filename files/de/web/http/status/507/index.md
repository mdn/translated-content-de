...
Dieser Statuscode wurde zuerst im Kontext von Web Distributed Authoring and Versioning ({{Glossary("WebDAV", "WebDAV")}}) verwendet, hat sich jedoch in andere Anwendungsfälle hinein verbreitet, um Situationen zu beschreiben, in denen Serverressourcen erschöpft sind.
