...
Der **`descent-override`** [CSS](/de/docs/Web/CSS) Deskriptor für die {{cssxref("@font-face")}} At-Regel definiert die Descent-Metrik für die Schriftart. Die Descent-Metrik ist die Höhe unter der Basislinie, die CSS verwendet, um Linienboxen in einem Inline-Formatierungskontext zu layouten.
