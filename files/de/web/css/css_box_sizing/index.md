...
Das [Modul für logische Eigenschaften und Werte](/de/docs/Web/CSS/Guides/Logical_properties_and_values) erweiterte die im Box-Modell und Box-Sizing-Modul verfügbaren Eigenschaften, um schreibmodusz-relative Entsprechungen der entsprechenden physischen Box-Modell- und intrinsischen Box-Sizing-Eigenschaften zu enthalten.
...
- [Beherrschung von Randkollaps](/de/docs/Web/CSS/Guides/Box_model/Margin_collapsing)
