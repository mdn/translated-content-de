...
Die **`matrix3d()`** [CSS](/de/docs/Web/CSS) [Funktion](/de/docs/Web/CSS/CSS_values_and_units/CSS_value_functions) definiert eine 3D-Transformation als eine 4x4 homogene Matrix. Das Ergebnis ist ein {{cssxref("&lt;transform-function&gt;")}} Datentyp.
...
Die `matrix3d()` Funktion wird mit 16 Werten spezifiziert. Sie werden in Spalten-major-Ordnung beschrieben.

- _a1_ _b1_ _c1_ _d1_ _a2_ _b2_ _c2_ _d2_
  _a3_ _b3_ _c3_ _d3_
  - : Sind {{cssxref("&lt;number&gt;")}}s, die die lineare Transformation beschreiben.
- _a4_ _b4_ _c4 d4_
  - : Sind {{cssxref("&lt;number&gt;")}}s, die die anzuwendende Verschiebung beschreiben.
...
Das folgende Beispiel zeigt einen 3D-Würfel, der aus DOM-Elementen und Transformationsvorgängen erstellt wurde und der beim Überfahren/Fokussieren eine `matrix3d()`-Transformation auf ihn anwendet.
...
### Beispiel für Matrixtranslation und Skalierung
