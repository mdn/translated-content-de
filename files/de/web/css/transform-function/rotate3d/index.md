...
- `x`
  - : Ist eine {{cssxref("&lt;number&gt;")}}, die die x-Koordinate des Vektors beschreibt, der die Drehachse angibt und eine positive oder negative Zahl sein kann.
- `y`
  - : Ist eine {{cssxref("&lt;number&gt;")}}, die die y-Koordinate des Vektors beschreibt, der die Drehachse angibt und eine positive oder negative Zahl sein kann.
- `z`
  - : Ist eine {{cssxref("&lt;number&gt;")}}, die die z-Koordinate des Vektors beschreibt, der die Drehachse angibt und eine positive oder negative Zahl sein kann.
- `a`
  - : Ist ein {{ cssxref("&lt;angle&gt;") }}, der den Drehwinkel darstellt. Ein positiver Winkel steht für eine Drehung im Uhrzeigersinn, ein negativer Winkel für eine gegen den Uhrzeigersinn.
