---
title: Converter für Farbformate
...
Geben Sie eine Farbe in einem beliebigen Format ein oder wählen Sie eine im sRGB-{{Glossary("color_space", "Farbraum")}}. Sie können auch die Deckkraft (Alphakanal) anpassen.
...
- [Anwenden von Farbe mit CSS-Eigenschaften](/de/docs/Web/CSS/Guides/Colors/Applying_color)
- [CSS-Farbwerte](/de/docs/Web/CSS/Guides/Colors/Color_values)
- [Farben klug verwenden](/de/docs/Web/CSS/Guides/Colors/Using_color_wisely)
