---
title: Anpassen von Hintergrundbildern mit background-size
short-title: Anpassen von Hintergrundbildern
...
Zusätzlich zu {{cssxref("&lt;length&gt;")}}-Werten bietet die {{cssxref("background-size")}}-CSS-Eigenschaft zwei spezielle Größenwerte, `contain` und `cover`. Lassen Sie uns diese genauer betrachten.
