---
title: Mozilla-CSS-Erweiterungen mit Vendor-Präfix
...
Firefox unterstützt eine Reihe von _Mozilla-Erweiterungen zu [CSS](/de/docs/Web/CSS)_, einschließlich Eigenschaften, Werte, Pseudo-Elemente und Pseudo-Klassen, At-Rules und Media Queries. Diese Erweiterungen sind mit `-moz-` vorangestellt.

> [!NOTE]
> Diese Erweiterungen sind meist experimentell oder veraltet, werden aber zur Rückwärtskompatibilität beibehalten. Vermeiden Sie die Verwendung auf Produktionswebsites.

## Nur in Mozilla verfügbare Eigenschaften
...
## Früher proprietäre Eigenschaften, die jetzt standardisiert sind

> [!NOTE]
> Um die Kompatibilität Ihres CSS zu maximieren, sollten Sie die unpräfixierten Standard-Eigenschaften anstelle der unten aufgeführten präfixierten verwenden. Sobald eine bestimmte Eigenschaft standardisiert und ohne Präfix implementiert wird, wird die Version mit Präfix normalerweise nach einiger Zeit eingestellt.

### A

- {{CSSxRef("animation", "-moz-animation")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("animation-delay", "-moz-animation-delay")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("animation-direction", "-moz-animation-direction")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("animation-duration", "-moz-animation-duration")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("animation-fill-mode", "-moz-animation-fill-mode")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("animation-iteration-count", "-moz-animation-iteration-count")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("animation-name", "-moz-animation-name")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("animation-play-state", "-moz-animation-play-state")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("animation-timing-function","-moz-animation-timing-function")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("appearance","-moz-appearance")}} {{Experimental_Inline}}

### B

- {{CSSxRef("backface-visibility", "-moz-backface-visibility")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
...
- {{CSSxRef("box-sizing", "-moz-box-sizing")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)

### C

- {{CSSxRef("clip-path")}} {{Experimental_Inline}} (Anwendung auf mehr als SVG)
- {{CSSxRef("column-count", "-moz-column-count")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("column-fill", "-moz-column-fill")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("column-gap", "-moz-column-gap")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("column-width", "-moz-column-width")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("column-rule", "-moz-column-rule")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("column-rule-width", "-moz-column-rule-width")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("column-rule-style", "-moz-column-rule-style")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("column-rule-color", "-moz-column-rule-color")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)

### F–M

- {{CSSxRef("filter")}} {{Experimental_Inline}} (Anwendung auf mehr als SVG)
- {{CSSxRef("font-feature-settings", "-moz-font-feature-settings")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("font-language-override", "-moz-font-language-override")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("hyphens", "-moz-hyphens")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
...
- {{CSSxRef("perspective", "-moz-perspective")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("perspective-origin", "-moz-perspective-origin")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
...
- {{CSSxRef("transform", "-moz-transform")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("transform-origin", "-moz-transform-origin")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("transform-style", "-moz-transform-style")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("transition", "-moz-transition")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("transition-delay", "-moz-transition-delay")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("transition-duration", "-moz-transition-duration")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("transition-property", "-moz-transition-property")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
- {{CSSxRef("transition-timing-function", "-moz-transition-timing-function")}} {{Deprecated_Inline}} (Version mit Präfix wird noch unterstützt)
...
- `-moz-use-text-color` {{deprecated_inline}} (entfernt im [Firefox Bug 1306214](https://bugzil.la/1306214)); verwenden Sie stattdessen {{CSSxRef("color_value#currentcolor_keyword","currentcolor")}}.
...
- [Vendor-Präfix](/de/docs/Glossary/Vendor_Prefix) Glossareintrag
