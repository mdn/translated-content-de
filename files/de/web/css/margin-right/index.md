...
Die vertikalen Ränder von zwei angrenzenden Boxen können verschmelzen. Dies wird als [_Kollaps der Ränder_](/de/docs/Web/CSS/CSS_box_model/Mastering_margin_collapsing) bezeichnet.
...
Die `margin-right` Eigenschaft wird als das Schlüsselwort `auto`, oder als `<length>`, oder als `<percentage>` angegeben. Ihr Wert kann positiv, null oder negativ sein.

### Werte

- {{cssxref("&lt;length&gt;")}}
  - : Die Größe des Randes als fester Wert.
    - Für _anker-positionierte Elemente_ löst die Funktion {{cssxref("anchor-size()")}} sich zu einem Wert {{cssxref("&lt;length&gt;")}} relativ zur Breite oder Höhe des zugehörigen _Ankerelements_ auf (siehe [Einstellung des Elementrandes basierend auf Ankergröße](/de/docs/Web/CSS/CSS_anchor_positioning/Using#setting_element_margin_based_on_anchor_size)).
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            wird der Wert auf die Zentrierung des Elements innerhalb seines Elternteils gesetzt.
          </td>
        ...
        <tr>
          ...
          <td>
            <code>0</code>, außer wenn sowohl <code>margin-left</code> als auch
            <code>margin-right</code> auf <code>auto</code> gesetzt sind. In diesem Fall
            wird der Wert auf die Zentrierung des Randbereichs innerhalb der verfügbaren
            <code>width</code> gesetzt, wenn fixer Modus.
          </td>
        ...
        <tr>
          ...
          <th><em>beliebig</em></th>
          <td>
            <code>0</code>, außer wenn es freien positiven horizontalen Raum gibt.
            In diesem Fall wird dieser gleichmäßig auf alle horizontalen
