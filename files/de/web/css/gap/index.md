...
- {{CSSxRef("&lt;length&gt;")}}
  - : Gibt die Breite der Rinne an, die Spalten, {{Glossary("flex_item", "flexible Elemente")}}, Flexzeilen und {{Glossary("grid_lines", "Gitternetzlinien")}} trennt.
- {{CSSxRef("&lt;percentage&gt;")}}
