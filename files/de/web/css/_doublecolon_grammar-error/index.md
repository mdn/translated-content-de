...
Der **`::grammar-error`** [CSS](/de/docs/Web/CSS) [Pseudo-Element](/de/docs/Web/CSS/Pseudo-elements) repräsentiert einen Textabschnitt, der vom {{Glossary("user_agent", "User Agent")}} als grammatikalisch falsch markiert wurde.
