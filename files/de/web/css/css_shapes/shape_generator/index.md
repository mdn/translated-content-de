...
Dieses Formgenerator-Tool kann verwendet werden, um die Koordinaten und Syntax für Funktionen zu definieren, die {{cssxref("&lt;basic-shape&gt;")}} verwenden.
...
Der Formgenerator hilft Ihnen, Grundformen zu visualisieren, indem er die Koordinaten jedes Punktes ausgibt, die über Ihr Bild gelegt werden. Laden Sie ein Bild hoch, indem Sie entweder ziehen oder klicken, um eine Datei auszuwählen. Wählen Sie dann den Typ der Form aus, die Sie erstellen möchten, aus dem Dropdown-Menü. Optional können Sie auch die Skalierung der Leinwand mit dem Bereichseingabefeld anpassen. Klicken Sie dann auf Punkte im Bild, um Bezugspunkte für die Form, die Sie erstellen möchten, hinzuzufügen. Das Tool gibt dann das Markup für den HTML `coords`-Attributwert, die CSS-Basisformfunktion mit Koordinaten und die SVG-Form aus.
