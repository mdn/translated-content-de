...
Dieses Modul definiert keine Eigenschaften, [Datentypen](/de/docs/Web/CSS/Reference/Values/Data_types), [Funktionen](/de/docs/Web/CSS/Reference/Values/Functions) oder [At-Regeln](/de/docs/Web/CSS/Guides/Syntax/At-rules). Vielmehr wird erklärt, wie all diese Features definiert werden sollten und wie Benutzeragenten CSS analysieren sollten.
