...
Die **`layer()`** [CSS](/de/docs/Web/CSS) [Funktion](/de/docs/Web/CSS/Reference/Values/Functions) wird zusammen mit der {{cssxref("@import")}} [At-Regel](/de/docs/Web/CSS/Guides/Syntax/At-rules) verwendet, um die importierte Ressource in eine separate benannte [Kaskadenschicht](/de/docs/Web/CSS/Reference/At-rules/@layer) zu setzen.
