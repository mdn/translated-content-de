...
- `auto`
  - : Gibt an, dass der fehlende Kleinbuchstabenschnitt bei Bedarf vom Browser synthetisiert werden darf.
- `none`
  - : Gibt an, dass die Synthese des fehlenden Kleinbuchstabenschnitts durch den Browser nicht erlaubt ist.
...
### Deaktivieren der Synthese des Kleinbuchstabenschnitts

Dieses Beispiel zeigt, wie die Synthese des Kleinbuchstabenschnitts durch den Browser in der Schriftart `Montserrat` ausgeschaltet wird.
