...
Die **`background-origin`** [CSS](/de/docs/Web/CSS)-Eigenschaft legt den Ursprung des Hintergrunds fest: von der Grenze, innerhalb der Grenze oder innerhalb der Auffüllung.
