...
Die **`border-radius`** [CSS](/de/docs/Web/CSS) Eigenschaft rundet die Ecken des äußeren Randes eines Elements ab. Sie können einen einzelnen Radius festlegen, um runde Ecken zu erzeugen, oder zwei Radien, um elliptische Ecken zu erstellen.
...
- optional gefolgt von "/" und ein, zwei, drei oder vier `<length>` oder `<percentage>` Werten. Dies wird verwendet, um einen zusätzlichen Radius festzulegen, sodass Sie elliptische Ecken haben können.
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        {{cssxref("&lt;percentage&gt;")}}, das einen Radius angibt, der für den Rand in jeder Ecke des Rahmens verwendet wird. Es
    ...
    <tr>
      ...
      <td>
        Ist eine {{cssxref("&lt;length&gt;")}} oder ein
        {{cssxref("&lt;percentage&gt;")}}, das einen Radius angibt, der für den Rand an den oberen linken und unteren rechten Ecken des
    ...
    <tr>
      ...
      <td>
        <img alt="Ein hellblaues Rechteck mit einem hellgrauen Rand. Die zwei Ecken oben rechts und unten links sind abgerundet." src="top-right-bottom-left.png" />
      </td>
      <td>
        Ist eine {{cssxref("&lt;length&gt;")}} oder ein
        {{cssxref("&lt;percentage&gt;")}}, das einen Radius angibt, der für den Rand an den oberen rechten und unteren linken Ecken des
    ...
    <tr>
      ...
      <td>
        Ist eine {{cssxref("&lt;length&gt;")}} oder ein
        {{cssxref("&lt;percentage&gt;")}}, das einen Radius angibt, der für den Rand an der oberen linken Ecke des Box-Elements
    ...
    <tr>
      ...
      <td>
        Ist eine {{cssxref("&lt;length&gt;")}} oder ein
        {{cssxref("&lt;percentage&gt;")}}, das einen Radius angibt, der für den Rand an der oberen rechten Ecke des Box-Elements
    ...
    <tr>
      ...
      <td>
        Ist eine {{cssxref("&lt;length&gt;")}} oder ein
        {{cssxref("&lt;percentage&gt;")}}, das einen Radius angibt, der für den Rand an der unteren rechten Ecke des Box-Elements
        verwendet wird. Es wird nur in der Drei- und Vier-Wert-Syntax verwendet.
      </td>
    </tr>
    <tr>
      ...
      <td>
        Ist eine {{cssxref("&lt;length&gt;")}} oder ein
        {{cssxref("&lt;percentage&gt;")}}, das einen Radius angibt, der für den Rand an der unteren linken Ecke des Box-Elements
        verwendet wird. Es wird nur in der Vier-Wert-Syntax verwendet.
      </td>
    </tr>
  </tbody>
...
Der Radius gilt für den gesamten {{cssxref("background")}}, auch wenn das Element keinen Rand hat; die genaue Position des Clippings wird durch die Eigenschaft {{cssxref("background-clip")}} definiert.
...
Wir geben der Box einige grundlegende Stile, die wir aus Gründen der Kürze ausgeblendet haben. Wir wenden auch eine {{cssxref("box-shadow")}}, einen `border-radius` von `0 20% 50px 30%` und eine `corner-shape` von `superellipse(0.5) bevel notch squircle` an.
