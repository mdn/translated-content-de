...
Um den Selektor auf nur den `<greenhouse>` Host direkt zu beschränken oder die Auswahl auf das DOM des Hosts zu beschränken, verwenden Sie stattdessen die {{cssxref(":host")}} oder {{cssxref(":host()")}} Pseudoklasse.

> [!NOTE]
> Dies hat keine Wirkung, wenn es außerhalb eines Shadow DOMs verwendet wird.

Die [Spezifität](/de/docs/Web/CSS/Guides/Cascade/Specificity) von `:host-context()` ist die einer [Pseudoklasse](/de/docs/Web/CSS/Reference/Selectors/Pseudo-classes), plus der Spezifität des Selektors, der als Argument der Funktion übergeben wird.
...
Die folgenden Ausschnitte sind aus unserem [host-selectors Beispiel](https://github.com/mdn/web-components-examples/tree/main/host-selectors) entnommen ([siehe es auch live](https://mdn.github.io/web-components-examples/host-selectors/)).
