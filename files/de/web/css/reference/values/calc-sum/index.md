...
Der **`<calc-sum>`** [CSS](/de/docs/Web/CSS) [Datentyp](/de/docs/Web/CSS/Reference/Values/Data_types) repräsentiert einen Ausdruck, der eine Berechnung mit einer beliebigen [CSS-Mathematikfunktion](/de/docs/Web/CSS/Reference/Values/Functions#math_functions) durchführt. Der Ausdruck führt eine grundlegende arithmetische Operation der Addition und Subtraktion zwischen zwei Werten aus.
