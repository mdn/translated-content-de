...
Die **`matrix3d()`** [CSS](/de/docs/Web/CSS) [Funktion](/de/docs/Web/CSS/Reference/Values/Functions) definiert eine 3D-Transformation als 4x4 homogene Matrix. Das Ergebnis ist ein {{cssxref("&lt;transform-function&gt;")}} Datentyp.
...
<table class="standard-table">
  <thead>
    <tr>
      <th scope="col"><a href="/de/docs/Web/CSS/Reference/Values/transform-function#cartesian_coordinates">Kartesische Koordinaten</a> in <a href="https://en.wikipedia.org/wiki/Real_coordinate_space">ℝ^2</a></th>
  ...
  <tbody>
    <tr>
      <td colspan="2">
        Diese Transformation wird auf den 3D-Raum angewendet und kann nicht in der Ebene dargestellt werden.
      </td>
      <td>
