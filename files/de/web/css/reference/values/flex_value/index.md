...
Der `<flex>`-Datentyp wird als {{cssxref("&lt;number&gt;")}} gefolgt von der Einheit `fr` angegeben. Die `fr`-Einheit repräsentiert einen Bruchteil des verbleibenden Raums im Grid-Container. Wie bei allen CSS-Dimensionen gibt es keinen Zwischenraum zwischen der Einheit und der Zahl.
...
### Beispiel für die Verwendung in einer Spuraufstellung für das CSS-Grid-Layout
