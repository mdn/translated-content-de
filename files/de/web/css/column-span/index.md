...
- `all`
  - : Das Element erstreckt sich über alle Spalten. Inhalt im normalen Fluss, der vor dem Element erscheint, wird automatisch über alle Spalten ausgewogen, bevor das Element erscheint. Das Element etabliert einen neuen Blockformatierungskontext.
...
- [Spanning und Balancing von Spalten](/de/docs/Web/CSS/CSS_multicol_layout/Spanning_balancing_columns)
