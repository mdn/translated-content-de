...
Die **`padding-right`** [CSS](/de/docs/Web/CSS) Eigenschaft legt die Breite des [Innenabstandsbereichs](/de/docs/Web/CSS/CSS_box_model/Introduction_to_the_CSS_box_model#padding_area) auf der rechten Seite eines Elements fest.
...
Die `padding-right` Eigenschaft wird als ein einzelner Wert gewählt aus der unten aufgeführten Liste angegeben. Im Gegensatz zu Margen sind negative Werte für den Innenabstand nicht erlaubt.
...
### Festlegen des rechten Innenabstands mit Pixeln und Prozentsätzen
