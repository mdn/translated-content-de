...
Dieser Artikel bietet einige XPath-Code-Snippets - einfache Beispiele, wie man einige einfache **Hilfsfunktionen** basierend auf standardmäßigen Schnittstellen aus der [DOM Level 3 XPath-Spezifikation](https://www.w3.org/TR/DOM-Level-3-XPath/) erstellt, die XPath-Funktionalität für JavaScript-Code bereitstellen. Die Snippets sind Funktionen, die Sie in der Praxis in Ihrem eigenen Code verwenden können.

### Knotenspezifische Evaluierungsfunktion

Die folgende benutzerdefinierte Hilfsfunktion kann verwendet werden, um XPath-Ausdrücke auf gegebenen XML-Knoten zu evaluieren. Das erste Argument ist ein DOM-Knoten oder ein Dokumenten-Objekt, während das zweite ein String ist, der einen XPath-Ausdruck definiert.
...
Die folgende Funktion ermöglicht es, ein Element und ein XML-Dokument zu übergeben, um einen einzigartigen XPath-Ausdruck als String zu finden, der zurück zu diesem Element führt.
