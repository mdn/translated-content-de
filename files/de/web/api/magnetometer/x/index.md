...
Die **`x`**-Schreibgeschützte Eigenschaft der [`Magnetometer`](/de/docs/Web/API/Magnetometer)-Schnittstelle gibt eine Zahl zurück, die das Magnetfeld um die x-Achse des Geräts angibt.
