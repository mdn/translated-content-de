...
Dieser Wert wird ermittelt, indem die Zeit beobachtet wird, die zwischen dem Senden der neuesten {{Glossary("STUN", "STUN")}}-Anfrage an den entfernten Peer und dem Eintreffen der Antwort auf diese Anfrage vergeht. Diese Informationen können sowohl von laufenden STUN-Konnektivitätsprüfungen als auch von Zustimmungsgesuchen stammen, die bei der anfänglichen Eröffnung der Verbindung gestellt wurden.
