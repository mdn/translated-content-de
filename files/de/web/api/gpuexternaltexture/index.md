...
Ein `GPUExternalTexture`-Objekt wird durch die Verwendung von [`GPUDevice.importExternalTexture()`](/de/docs/Web/API/GPUDevice/importExternalTexture) instanziiert.
