...
- [`InputEvent.getTargetRanges()`](/de/docs/Web/API/InputEvent/getTargetRanges)
  - : Gibt ein Array von [`StaticRange`](/de/docs/Web/API/StaticRange)-Objekten zurück, die von einer Änderung am DOM betroffen sein werden, wenn das Input-Ereignis nicht abgebrochen wird.
