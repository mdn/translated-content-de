...
Die **`transaction`** schreibgeschützte Eigenschaft des
[`IDBObjectStore`](/de/docs/Web/API/IDBObjectStore)-Interfaces gibt das Transaktionsobjekt zurück, zu dem dieser
Objektspeicher gehört.
