...
Die **`minimumFieldOfView`** Eigenschaft des [`VREyeParameters`](/de/docs/Web/API/VREyeParameters) Interfaces beschreibt das minimale unterstützte Sichtfeld für das aktuelle Auge.
