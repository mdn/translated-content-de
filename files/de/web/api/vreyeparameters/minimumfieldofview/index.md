...
Die **`minimumFieldOfView`** schreibgeschützte Eigenschaft des [`VREyeParameters`](/de/docs/Web/API/VREyeParameters)-Interfaces beschreibt das minimal unterstützte Sichtfeld für das aktuelle Auge.
...
Diese Eigenschaft war Teil der alten [WebVR API](https://immersive-web.github.io/webvr/spec/1.1/), die durch die [WebXR Device API](https://immersive-web.github.io/webxr/) ersetzt wurde. Sie ist nicht mehr auf dem Weg, zu einem Standard zu werden.
