...
Die schreibgeschützte Eigenschaft **`maximumFieldOfView`** der [`VREyeParameters`](/de/docs/Web/API/VREyeParameters)-Schnittstelle beschreibt das maximal unterstützte Sichtfeld für das aktuelle Auge.
