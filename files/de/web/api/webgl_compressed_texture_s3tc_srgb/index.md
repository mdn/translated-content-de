...
> [!NOTE]
> Diese Erweiterung ist sowohl für die {{domxref("WebGLRenderingContext", "WebGL1", "", 1)}} als auch für die {{domxref("WebGL2RenderingContext", "WebGL2", "", 1)}} Kontexte verfügbar.
