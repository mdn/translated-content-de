---
title: "HTMLTableRowElement: ch-Eigenschaft"
short-title: ch
...
Die **`ch`**-Eigenschaft des {{domxref("HTMLTableRowElement")}}-Interfaces hat keine Funktion. Sie spiegelt das `char`-Attribut des {{HTMLElement("tr")}}-Elements wider.
