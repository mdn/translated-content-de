...
Die schreibgeschützte Eigenschaft **`activeVRDisplays`** des [`Navigator`](/de/docs/Web/API/Navigator)-Interfaces gibt ein Array zurück, das jedes [`VRDisplay`](/de/docs/Web/API/VRDisplay)-Objekt enthält, das derzeit präsentiert wird ([`VRDisplay.ispresenting`](/de/docs/Web/API/VRDisplay/ispresenting) ist `true`).
