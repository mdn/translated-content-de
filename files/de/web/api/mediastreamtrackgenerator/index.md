...
Die **`MediaStreamTrackGenerator`**-Schnittstelle der [Insertable Streams for MediaStreamTrack API](/de/docs/Web/API/Insertable_Streams_for_MediaStreamTrack_API) erstellt einen [`WritableStream`](/de/docs/Web/API/WritableStream), der als Quelle für einen [`MediaStreamTrack`](/de/docs/Web/API/MediaStreamTrack) fungiert.
Das Objekt verbraucht einen Strom von Medien-Frames als Eingabe, die entweder Audio- oder Video-Frames sein können.
...
_Diese Schnittstelle erbt auch Eigenschaften von [`MediaStreamTrack`](/de/docs/Web/API/MediaStreamTrack)._
