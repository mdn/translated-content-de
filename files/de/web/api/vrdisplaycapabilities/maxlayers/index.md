...
Eine Zahl, die 1 sein muss, wenn [`VRDisplayCapabilities.canPresent`](/de/docs/Web/API/VRDisplayCapabilities/canPresent) `true` ist, oder 0, wenn nicht.
