...
Der **`DOMPointReadOnly()`** Konstruktor gibt ein neues {{domxref("DOMPointReadOnly")}}-Objekt zurück, das einen Punkt im 2D- oder 3D-Raum darstellt, optional mit Perspektive, dessen Werte nicht durch Skriptcode verändert werden können.
...
Ein neues {{domxref("DOMPointReadOnly")}}-Objekt, das den angegebenen Ort im Raum darstellt.

## Beispiele

Der folgende Code zeigt die Erstellung von sowohl 2D- als auch 3D-Punkten.
