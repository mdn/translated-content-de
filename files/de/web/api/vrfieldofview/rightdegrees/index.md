---
title: "VRFieldOfView: Eigenschaft rightDegrees"
...
Die schreibgeschützte Eigenschaft **`rightDegrees`** der {{domxref("VRFieldOfView")}}-Schnittstelle gibt die Anzahl der Grad zurück, um die sich das Sichtfeld nach rechts erstreckt.
