...
- `firstVertex` {{optional_inline}}
  - : Eine Zahl, die den Offset in den Vertex-Puffern in Vertices definiert, ab dem das Zeichnen beginnt. Wenn weggelassen, ist der Standardwert für `firstVertex` 0.
