...
- [`MediaEncryptedEvent.initDataType`](/de/docs/Web/API/MediaEncryptedEvent/initDataType) {{ReadOnlyInline}}
  - : Gibt einen groß-/kleinschreibungssensitiven String mit dem _Typ_ des Formats der gefundenen Initialisierungsdaten zurück.
...
_Diese Schnittstelle bietet keine spezifischen Methoden, aber erbt Methoden von ihrem Elternteil, [`Event`](/de/docs/Web/API/Event)._
