...
- [`finished`](/de/docs/Web/API/NavigationTransition/finished) {{ReadOnlyInline}}
  - : Gibt ein {{jsxref("Promise")}} zurück, das zu dem Zeitpunkt erfüllt wird, wenn das [`navigatesuccess`](/de/docs/Web/API/Navigation/navigatesuccess_event) Ereignis ausgelöst wird, oder zu dem Zeitpunkt abgelehnt wird, wenn das [`navigateerror`](/de/docs/Web/API/Navigation/navigateerror_event) Ereignis ausgelöst wird.
...
- [Navigation API Live-Demo](https://mdn.github.io/dom-examples/navigation-api/) ([Demosource anzeigen](https://github.com/mdn/dom-examples/tree/main/navigation-api))
