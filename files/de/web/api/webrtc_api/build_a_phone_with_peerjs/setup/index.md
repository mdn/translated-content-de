...
Lassen Sie uns mit der Einrichtung der Grundlagen für unsere WebRTC-gestützte Telefon-App beginnen.

1. Finden Sie zunächst einen geeigneten Platz in Ihrer lokalen Dateistruktur und führen Sie `mkdir audio_app` und dann `cd audio_app` aus, um ein Verzeichnis für Ihre App zu erstellen und es zu betreten.
...
3. Installieren Sie dann die erforderlichen Abhängigkeiten mit den folgenden Befehlen:
   ...
   Peer wird für den Peer-Server verwendet, und PeerJS wird verwendet, um auf die PeerJS API und das Framework zuzugreifen. Ihre `package.json` sollte in etwa so aussehen, wenn Sie mit der Installation der Abhängigkeiten fertig sind:
