...
{{jsxref("Iteration_protocols",'Iterator')}} zurück, der es Ihnen ermöglicht, alle in diesem Objekt enthaltenen Schlüssel zu durchlaufen. Die Schlüssel sind {{jsxref("String")}}-Objekte.
