...
Das **`CSSTransformComponent`**-Interface der [CSS Typed Object Model API](/de/docs/Web/API/CSS_Object_Model) ist das Basis-Interface für Objekte, die einzelne [Transformationsfunktionen](/de/docs/Web/CSS/Reference/Values/transform-function) darstellen, etwa [`rotate()`](/de/docs/Web/CSS/Reference/Values/transform-function/rotate) und [`scale()`](/de/docs/Web/CSS/Reference/Values/transform-function/scale).
...
Stattdessen repräsentiert das [`CSSTransformValue`](/de/docs/Web/API/CSSTransformValue)-Interface die `transform-list` selbst und kann iteriert werden, um jeden der Werte in der Transformation abzurufen.

Die [konkreten Interfaces, die jede Transformationsfunktion darstellen](#interfaces_based_on_csstransformcomponent), sind im vorherigen Abschnitt aufgeführt (das Interface verfügt über keinen eigenen Konstruktor und kann daher nicht direkt instanziiert werden).
