...
Die **`offsetX`**-Eigenschaft der [`MouseEvent`](/de/docs/Web/API/MouseEvent)-Schnittstelle gibt den Versatz der X-Koordinate des Mauszeigers zwischen diesem Ereignis und dem Padding-Rand des Zielknotens an.
