...
- [`SVGFEDropShadowElement.stdDeviationX`](/de/docs/Web/API/SVGFEDropShadowElement/stdDeviationX) {{ReadOnlyInline}}
  - : Ein [`SVGAnimatedNumber`](/de/docs/Web/API/SVGAnimatedNumber), das der (möglicherweise automatisch berechneten) X-Komponente des {{SVGAttr("stdDeviationX")}}-Attributs des angegebenen Elements entspricht.
- [`SVGFEDropShadowElement.stdDeviationY`](/de/docs/Web/API/SVGFEDropShadowElement/stdDeviationY) {{ReadOnlyInline}}
  - : Ein [`SVGAnimatedNumber`](/de/docs/Web/API/SVGAnimatedNumber), das der (möglicherweise automatisch berechneten) Y-Komponente des {{SVGAttr("stdDeviationY")}}-Attributs des angegebenen Elements entspricht.
