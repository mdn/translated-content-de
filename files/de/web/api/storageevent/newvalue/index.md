...
Die **`newValue`**-Eigenschaft des [`StorageEvent`](/de/docs/Web/API/StorageEvent)-Interfaces gibt den neuen Wert des Speicherobjekts zurück, dessen Wert geändert wurde.
