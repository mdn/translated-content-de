...
Die **`value`** schreibgeschützte Eigenschaft der [`IDBCursorWithValue`](/de/docs/Web/API/IDBCursorWithValue)-Schnittstelle gibt den Wert des aktuellen Cursors zurück, was auch immer das ist.
...
In diesem Beispiel erstellen wir eine Transaktion, rufen einen Objektspeicher ab und verwenden dann einen Cursor, um durch alle Datensätze im Objektspeicher zu iterieren. Innerhalb jeder Iteration protokollieren wir den Wert des Cursors mit `cursor.value`.
