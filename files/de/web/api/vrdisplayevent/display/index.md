...
Die **`display`** schreibgeschützte Eigenschaft des [`VRDisplayEvent`](/de/docs/Web/API/VRDisplayEvent)-Interfaces gibt das [`VRDisplay`](/de/docs/Web/API/VRDisplay) zurück, das mit diesem Ereignis verknüpft ist.
