...
Die **`display`**-Eigenschaft der [`VRDisplayEvent`](/de/docs/Web/API/VRDisplayEvent)-Schnittstelle gibt das [`VRDisplay`](/de/docs/Web/API/VRDisplay) zurück, das mit diesem Ereignis verknüpft ist.
