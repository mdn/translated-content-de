...
Die **`linearVelocity`** schreibgeschützte Eigenschaft des {{domxref("GamepadPose")}}-Interfaces gibt ein Array zurück, das den linearen Geschwindigkeitsvektor des {{domxref("Gamepad")}} in Metern pro Sekunde darstellt.
