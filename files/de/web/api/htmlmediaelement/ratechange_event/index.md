...
Diese Beispiele fügen einen Ereignis-Listener für das `ratechange`-Ereignis des HTMLMediaElements hinzu und geben eine Meldung aus, wenn der Ereignis-Handler auf das Auslösen des Ereignisses reagiert hat.
...
Verwendung der `onratechange`-Event-Handler-Eigenschaft:
