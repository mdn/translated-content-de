...
Die **`disableRemotePlayback`**-Eigenschaft der {{domxref("HTMLMediaElement")}}-Schnittstelle bestimmt, ob das Media-Element eine Remote-Wiedergabe-Benutzeroberfläche haben darf.

## Wert

Ein boolescher Wert, der anzeigt, ob das Media-Element eine Remote-Wiedergabe-Benutzeroberfläche haben darf. (`false` bedeutet "nicht deaktiviert", was "aktiviert" bedeutet)
