...
- `divisor`
  - : Ein [`GLuint`](/de/docs/Web/API/WebGL_API/Types), der die Anzahl der Instanzen angibt, die zwischen den Aktualisierungen des generischen Attributs vergehen.
