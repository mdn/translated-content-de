...
Die schreibgeschützte **`inlineVerticalFieldOfView`**-Eigenschaft des [`XRRenderState`](/de/docs/Web/API/XRRenderState)-Interfaces gibt das Standard-Sichtfeld für "`inline`"-Sitzungen zurück und `null` für alle immersiven Sitzungen.
