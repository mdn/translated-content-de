...
Die **`BluetoothRemoteGATTDescriptor.writeValue()`**-Methode setzt die Eigenschaft `value` auf die Bytes, die in einem {{jsxref("ArrayBuffer")}} enthalten sind, und gibt ein {{jsxref("Promise")}} zurück.
