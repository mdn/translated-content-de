---
title: "CookieChangeEvent: Eigenschaft 'changed'"
short-title: changed
...
- `sameSite`
  ...
  - : Einer der folgenden [`SameSite`](/de/docs/Web/HTTP/Headers/Set-Cookie#samesitesamesite-value)-Werte:
    ...
    - `"strict"`
      - : Cookies werden nur im Erstanbieterkontext gesendet und nicht mit Anfragen, die von Drittanbieter-Websites initiiert werden.
    - `"lax"`
      - : Cookies werden bei normalen Cross-Site-Subanfragen nicht gesendet (zum Beispiel zum Laden von Bildern oder Frames in eine Drittanbieter-Site), aber sie werden gesendet, wenn ein Benutzer innerhalb der Ursprungsseite navigiert (d.h. beim Folgen eines Links).
    - `"none"`
...
In diesem Beispiel protokolliert der Event-Listener die `changed`-Eigenschaft in der Konsole, wenn das Cookie gesetzt wird. Das erste Element in diesem Array enthält ein Objekt, das das gerade gesetzte Cookie darstellt.
