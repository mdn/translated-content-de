...
Die **`stream`** schreibgeschützte Eigenschaft des [`MediaRecorder`](/de/docs/Web/API/MediaRecorder)-Interfaces gibt den Stream zurück, der an den [`MediaRecorder()`](/de/docs/Web/API/MediaRecorder/MediaRecorder)-Konstruktor übergeben wurde, als der `MediaRecorder` erstellt wurde.

## Wert

Der [`MediaStream`](/de/docs/Web/API/MediaStream), der beim ursprünglichen Erstellen des `MediaRecorder` an den `MediaRecorder()`-Konstruktor übergeben wurde.
