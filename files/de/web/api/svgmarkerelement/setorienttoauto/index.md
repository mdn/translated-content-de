---
title: "SVGMarkerElement: Methode setOrientToAuto()"
...
Die **`setOrientToAuto()`**-Methode der {{domxref("SVGMarkerElement")}}-Schnittstelle setzt den Wert des `orient`-Attributs auf `auto`.
