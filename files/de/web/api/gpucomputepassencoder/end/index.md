...
Die **`end()`**-Methode der [`GPUComputePassEncoder`](/de/docs/Web/API/GPUComputePassEncoder)-Schnittstelle beendet die Aufzeichnung der aktuellen Kommandosequenz des Compute-Passes.
...
- Der [`GPUComputePassEncoder`](/de/docs/Web/API/GPUComputePassEncoder) ist geöffnet (d.h. nicht bereits durch einen `end()`-Aufruf beendet).
