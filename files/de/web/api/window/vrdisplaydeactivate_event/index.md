...
Das **`vrdisplaydeactivate`**-Ereignis der [WebVR-API](/de/docs/Web/API/WebVR_API) wird ausgelöst, wenn ein VR-Display nicht mehr präsentiert werden kann, beispielsweise wenn ein HMD aufgrund einer Inaktivitätsperiode in den Standby- oder Schlafmodus gewechselt ist.
