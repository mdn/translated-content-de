...
Das nicht standardisierte **`webkitmouseforceup`**-Ereignis wird von Safari an einem [`Element`](/de/docs/Web/API/Element) ausgelöst, einige Zeit nachdem das [`webkitmouseforcedown`](/de/docs/Web/API/Element/webkitmouseforcedown_event)-Ereignis ausgelöst wurde, wenn der Druck auf den Knopf ausreichend verringert wurde, um den "Force-Klick" zu beenden.

**`webkitmouseforceup`** ist ein proprietäres, WebKit-spezifisches Ereignis. Es ist Teil der Funktion für [Force Touch Events](/de/docs/Web/API/Force_Touch_events).
...
- [`MouseEvent.offsetX`](/de/docs/Web/API/MouseEvent/offsetX) {{ReadOnlyInline}}
  - : Die X-Koordinate des Mauszeigers relativ zur Position der Polsterungkante des Zielknotens.
- [`MouseEvent.offsetY`](/de/docs/Web/API/MouseEvent/offsetY) {{ReadOnlyInline}}
  - : Die Y-Koordinate des Mauszeigers relativ zur Position der Polsterungkante des Zielknotens.
...
_Nicht Teil einer Spezifikation._ Apple bietet [eine Beschreibung in der Mac Developer Library](https://developer.apple.com/library/archive/documentation/AppleApplications/Conceptual/SafariJSProgTopics/RespondingtoForceTouchEventsfromJavaScript.html).
