...
Die Methode **`getHTML()`** des Interfaces [`Element`](/de/docs/Web/API/Element) wird verwendet, um das DOM eines Elements in einen HTML-String zu serialisieren.
...
Ohne Argumente werden Kindknoten, die Shadow Roots sind, nicht serialisiert, und diese Methode verhält sich genauso wie das Auslesen des Werts von [`Element.innerHTML`](/de/docs/Web/API/Element/innerHTML).
...
- `options` {{optional_inline}}
  - : Ein Optionsobjekt mit den folgenden optionalen Parametern:
    ...
    - `shadowRoots`
      - : Ein Array von [`ShadowRoot`](/de/docs/Web/API/ShadowRoot)-Objekten, das serialisiert werden soll.
