...
Dieses Ereignis wird zuerst nach dem [`mousedown`](/de/docs/Web/API/Element/mousedown_event) Ereignis und hört auf, bevor das [`mouseup`](/de/docs/Web/API/Element/mouseup_event) Ereignis ausgelöst wird.
...
- [`MouseEvent.relatedTarget`](/de/docs/Web/API/MouseEvent/relatedTarget) {{ReadOnlyInline}}
  - : Das zweite Ziel des Ereignisses, falls vorhanden.
...
- [`MouseEvent.webkitForce`](/de/docs/Web/API/MouseEvent/webkitForce) {{non-standard_inline()}} {{ReadOnlyInline}}
  - : Die Menge des Drucks, die beim Klicken ausgeübt wird.
