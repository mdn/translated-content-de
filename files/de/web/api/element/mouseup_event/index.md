...
Das **`mouseup`**-Ereignis wird bei einem [`Element`](/de/docs/Web/API/Element) ausgelöst, wenn eine Taste auf einem Zeigegerät (wie einer Maus oder einem Trackpad) losgelassen wird, während sich der Zeiger innerhalb des Elements befindet.
