...
Die **`displayName`**-Eigenschaft (nur lesbar) der [`VRDisplay`](/de/docs/Web/API/VRDisplay)-Schnittstelle gibt einen menschenlesbaren Namen zurück, um das `VRDisplay` zu identifizieren.
