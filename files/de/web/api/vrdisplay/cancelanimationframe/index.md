...
- `handle`
  - : Der Handle, der von dem [`VRDisplay.requestAnimationFrame()`](/de/docs/Web/API/VRDisplay/requestAnimationFrame)-Aufruf zurückgegeben wurde und den Sie abmelden möchten.
