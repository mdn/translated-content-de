...
Die **`capabilities`** schreibgeschützte Eigenschaft der {{domxref("VRDisplay")}}-Schnittstelle gibt ein {{domxref("VRDisplayCapabilities")}}-Objekt zurück, das die verschiedenen Fähigkeiten des `VRDisplay` angibt.
...
Ein {{domxref("VRDisplayCapabilities")}}-Objekt.
