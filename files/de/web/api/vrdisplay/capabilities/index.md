...
Die **`capabilities`** schreibgeschützte Eigenschaft des [`VRDisplay`](/de/docs/Web/API/VRDisplay)-Interfaces gibt ein [`VRDisplayCapabilities`](/de/docs/Web/API/VRDisplayCapabilities)-Objekt zurück, das die verschiedenen Fähigkeiten des `VRDisplay` angibt.
