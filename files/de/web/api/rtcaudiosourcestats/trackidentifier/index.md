...
Die **`trackIdentifier`**-Eigenschaft des [`RTCAudioSourceStats`](/de/docs/Web/API/RTCAudioSourceStats)-Wörterbuchs enthält das `id`-Attribut des zugehörigen [`MediaStreamTrack`](/de/docs/Web/API/MediaStreamTrack).
