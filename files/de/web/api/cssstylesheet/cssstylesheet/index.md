...
l10n:
  sourceCommit: 74055e0c1629de16b6f482a363339371aa67e984
---
...
- `options` {{optional_inline}}
  ...
  - : Ein Objekt, das Folgendes enthält:
    ...
    - `media` {{optional_inline}}
      - : Eine [`MediaList`](/de/docs/Web/API/MediaList), die eine Liste von Mediensregeln enthält, oder ein String, der eine einzelne Regel enthält.
...
Das Ausdrucken von [`StyleSheet.media`](/de/docs/Web/API/StyleSheet/media) in die Konsole gibt eine [`MediaList`](/de/docs/Web/API/MediaList) mit einem einzigen Eintrag für diese Druckregel zurück.
...
Der untenstehende Code zeigt, wie das Stylesheet erstellt wird und dann [`CSSStyleSheet.replaceSync()`](/de/docs/Web/API/CSSStyleSheet/replaceSync) aufgerufen wird, um der Liste eine Regel hinzuzufügen.
...
Unten fügen wir eine neue Regel zum selben Stylesheet hinzu, indem wir [`CSSStyleSheet.insertRule()`](/de/docs/Web/API/CSSStyleSheet/insertRule) verwenden.
...
Weitere Beispiele finden Sie unter [`ShadowRoot.adoptedStyleSheets`](/de/docs/Web/API/ShadowRoot/adoptedStyleSheets).
