...
Die **`getDepthInMeters()`**-Methode der [`XRCPUDepthInformation`](/de/docs/Web/API/XRCPUDepthInformation)-Schnittstelle gibt die Tiefe in Metern bei (x, y) in normalisierten Ansichtskoordinaten zurück (Ursprung in der oberen linken Ecke).
