---
title: "GPUCommandEncoder: Methode clearBuffer()"
...
- `offset` {{optional_inline}}
  - : Eine Zahl, die den Versatz in Bytes vom Anfang des `buffer` zur zu löschenden Unterregion darstellt. Wenn nicht angegeben, ist der Standardwert für `offset` 0.
- `size` {{optional_inline}}
  - : Eine Zahl, die die Größe in Bytes der zu löschenden Unterregion darstellt. Wenn nicht angegeben, entspricht `size` der `buffer`-Größe minus `offset`.
