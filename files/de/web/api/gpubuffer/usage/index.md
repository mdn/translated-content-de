...
Die **`usage`**-Eigenschaft der [`GPUBuffer`](/de/docs/Web/API/GPUBuffer)-Schnittstelle enthält die {{Glossary("bitwise_flags", "bitweisen Flags")}}, die die erlaubten Verwendungen des `GPUBuffer` darstellen. Diese Eigenschaft ist nur lesbar.
