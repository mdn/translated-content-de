...
Dieser Code stammt aus unserem [Sprachgesteuerte Farbänderung](https://github.com/mdn/dom-examples/blob/main/web-speech-api/speech-color-changer/script.js)-Beispiel.
