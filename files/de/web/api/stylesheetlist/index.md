...
Es ist ein array-ähnliches Objekt, kann aber nicht mit {{jsxref("Array")}} Methoden durchlaufen werden. Es kann jedoch in einer Standardschleife mit {{jsxref("Statements/for", "for")}} über seine Indizes durchlaufen oder in ein {{jsxref("Array")}} umgewandelt werden.

> [!NOTE]
> Typischerweise umfassen Listen-Interfaces wie `StyleSheetList` {{jsxref("Array")}} Typen, sodass Sie `Array`-Methoden auf ihnen verwenden können.
