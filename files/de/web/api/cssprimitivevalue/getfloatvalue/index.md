...
Die **`getFloatValue()`**-Methode der [`CSSPrimitiveValue`](/de/docs/Web/API/CSSPrimitiveValue)-Schnittstelle wird verwendet, um einen Fließkommawert in einer bestimmten Einheit zu erhalten. Wenn dieser CSS-Wert keinen Fließkommawert enthält oder nicht in die angegebene Einheit umgewandelt werden kann, wird eine [`DOMException`](/de/docs/Web/API/DOMException) ausgelöst.
...
<table class="no-markdown">
  ...
  <tbody>
    <tr>
      ...
      <td>
        Ein <code>INVALID_ACCESS_ERR</code> wird ausgelöst, wenn der CSS-Wert keinen Fließkommawert enthält oder wenn der Fließkommawert nicht in die angegebene Einheit umgewandelt werden kann.
      </td>
    </tr>
  </tbody>
</table>
