...
Die **`item()`**-Methode der {{domxref("FileList")}}-Schnittstelle gibt ein {{domxref("File")}}-Objekt zurück, das die Datei am angegebenen Index in der Dateiliste darstellt.
...
Ein {{domxref("File")}}-Objekt, das die angeforderte Datei darstellt.
