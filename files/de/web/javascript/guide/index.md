...
Der JavaScript-Leitfaden zeigt Ihnen, wie Sie [JavaScript](/de/docs/Web/JavaScript) verwenden, und gibt einen Überblick über die Sprache. Wenn Sie umfassende Informationen zu einem Sprachmerkmal benötigen, werfen Sie einen Blick auf das [JavaScript-Referenzhandbuch](/de/docs/Web/JavaScript/Reference).
...
Übersicht: [Zahlen und Zeichenketten](/de/docs/Web/JavaScript/Guide/Numbers_and_strings)
...
## Darstellung von Daten & Zeiten

Übersicht: [Darstellung von Daten & Zeiten](/de/docs/Web/JavaScript/Guide/Representing_dates_times)

- [`Date`-Objekt](/de/docs/Web/JavaScript/Guide/Representing_dates_times#date_object)

## Reguläre Ausdrücke

Übersicht: [Reguläre Ausdrücke](/de/docs/Web/JavaScript/Guide/Regular_expressions)

- [Erstellen eines regulären Ausdrucks](/de/docs/Web/JavaScript/Guide/Regular_expressions#creating_a_regular_expression)
- [Schreiben eines Musters für reguläre Ausdrücke](/de/docs/Web/JavaScript/Guide/Regular_expressions#writing_a_regular_expression_pattern)
...
Übersicht: [Schlüsselsammlungen](/de/docs/Web/JavaScript/Guide/Keyed_collections)
...
Übersicht: [Internationalisierung](/de/docs/Web/JavaScript/Guide/Internationalization)
...
Nachdem Sie alle grundlegenden Funktionen von JavaScript gelernt haben, können Sie einige speziellere Funktionen erforschen oder tiefer in die Mechanismen und Konzepte der Sprache eintauchen.
...
- [Vererbung und Prototypketten](/de/docs/Web/JavaScript/Guide/Inheritance_and_the_prototype_chain)
