...
- `class` Deklarationen können erst nach der Stelle des Deklarationsortes aufgerufen werden (siehe [temporal dead zone](/de/docs/Web/JavaScript/Reference/Statements/let#temporal_dead_zone_tdz)). Aus diesem Grund werden `class`-Deklarationen allgemein als {{Glossary("Hoisting", "nicht-gehoistet")}} angesehen (im Gegensatz zu [Funktionsdeklarationen](/de/docs/Web/JavaScript/Reference/Statements/function)).
