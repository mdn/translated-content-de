...
Der **bitweise OR-Zuweisungsoperator (`|=`)** führt ein [bitweises OR](/de/docs/Web/JavaScript/Reference/Operators/Bitwise_OR) an den beiden Operanden durch und weist das Ergebnis dem linken Operanden zu.
...
- [Bitweise OR (`|`)](/de/docs/Web/JavaScript/Reference/Operators/Bitwise_OR)
