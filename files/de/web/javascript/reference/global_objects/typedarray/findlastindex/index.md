...
- `callbackFn`
  - : Eine Funktion, die für jedes Element im typisierten Array ausgeführt wird. Sie sollte einen [truthy](/de/docs/Glossary/Truthy) Wert zurückgeben, um anzuzeigen, dass ein übereinstimmendes Element gefunden wurde, und einen [falsy](/de/docs/Glossary/Falsy) Wert andernfalls. Die Funktion wird mit den folgenden Argumenten aufgerufen:
    - `element`
...
Der Index des letzten (höchstindexierten) Elements im typisierten Array, das den Test besteht. Andernfalls `-1`, wenn kein übereinstimmendes Element gefunden wird.
...
Im folgenden Beispiel wird der Index des letzten Elements im typisierten Array zurückgegeben, das eine Primzahl ist, oder `-1`, wenn keine Primzahl vorhanden ist.
