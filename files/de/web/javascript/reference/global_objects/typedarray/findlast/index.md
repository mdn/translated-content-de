...
Das letzte (höchstindizierte) Element im typisierten Array, das die bereitgestellte Testfunktion erfüllt; {{jsxref("undefined")}}, wenn kein übereinstimmendes Element gefunden wird.
...
Die folgenden Beispiele zeigen, dass alle Elemente _besucht werden_, und dass der Wert, der an das Callback übergeben wird, ihr Wert ist, wenn sie besucht werden:
