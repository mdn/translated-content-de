...
Wenn Sie die Parameter `monthValue` und `dateValue` nicht angeben, werden dieselben Werte wie die verwendet, die von {{jsxref("Date/getMonth", "getMonth()")}} und {{jsxref("Date/getDate", "getDate()")}} zurückgegeben werden.
