...
Die **`getUTCFullYear()`** Methode von {{jsxref("Date")}} Instanzen gibt das Jahr dieses Datums gemäß der Weltzeit zurück.
...
Ein ganzzahliger Wert, der das Jahr für das angegebene Datum gemäß der Weltzeit darstellt. Gibt `NaN` zurück, wenn das Datum [ungültig](/de/docs/Web/JavaScript/Reference/Global_Objects/Date#the_epoch_timestamps_and_invalid_date) ist.
