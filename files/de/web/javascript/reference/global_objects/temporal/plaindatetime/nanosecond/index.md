...
Die **`nanosecond`** Accessor-Eigenschaft von {{jsxref("Temporal.PlainDateTime")}}-Instanzen gibt eine ganze Zahl von 0 bis 999 zurück, die die Nanosekunden-Komponente (10<sup>-9</sup> Sekunde) dieser Zeit darstellt.
