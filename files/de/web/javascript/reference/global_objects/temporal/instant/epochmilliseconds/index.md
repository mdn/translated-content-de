...
Die **`epochMilliseconds`** Accessor-Eigenschaft von {{jsxref("Temporal.Instant")}}-Instanzen gibt eine Ganzzahl zurück, die die Anzahl der Millisekunden darstellt, die seit dem Unix-Epoch-Zeitpunkt (Mitternacht zu Beginn des 1. Januar 1970, UTC) bis zu diesem Moment vergangen sind. Sie ist gleichbedeutend mit der Division von `epochNanoseconds` durch `1e6` und der Abrundung des Ergebnisses.
