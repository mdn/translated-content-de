...
Das **`Int16Array`** Typ-Array repräsentiert ein Array von 16-Bit-Ganzzahlen im Vorzeichenbit im Byte-Format der Plattform. Falls Kontrolle über die Byte-Reihenfolge nötig ist, verwenden Sie stattdessen {{jsxref("DataView")}}. Die Inhalte sind auf `0` initialisiert, es sei denn, es werden explizit Initialisierungsdaten bereitgestellt. Sobald das Array eingerichtet ist, können Sie Elemente im Array mithilfe der Methoden des Objekts oder der Standard-Array-Indizierungssyntax (d.h. Verwendung der Klammernotation) referenzieren.
...
_Übernimmt ebenfalls statische Eigenschaften von seinem übergeordneten {{jsxref("TypedArray")}}_.
...
_Übernimmt ebenfalls Instanz-Eigenschaften von seinem übergeordneten {{jsxref("TypedArray")}}_.
