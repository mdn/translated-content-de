...
`Object.fromEntries()` führt das Gegenteil von {{jsxref("Object.entries()")}} aus, außer dass `Object.entries()` nur string-indizierte Eigenschaften zurückgibt, während `Object.fromEntries()` auch symbol-indizierte Eigenschaften erstellen kann.

> [!NOTE]
> Im Gegensatz zu {{jsxref("Array.from()")}} nutzt `Object.fromEntries()` nicht den Wert von `this`, sodass ein Aufruf auf einem anderen Konstruktor keine Objekte dieses Typs erstellt.
