...
Die **`propertyIsEnumerable()`** Methode von {{jsxref("Object")}} Instanzen gibt einen booleschen Wert zurück, der angibt, ob die angegebene Eigenschaft eine [enumerierbare eigene](/de/docs/Web/JavaScript/Enumerability_and_ownership_of_properties) Eigenschaft dieses Objekts ist.
...
Die meisten eingebauten Eigenschaften sind standardmäßig nicht enumerierbar, während benutzererstellte Objekteigenschaften oft enumerierbar sind, es sei denn, sie sind ausdrücklich anders gekennzeichnet.
...
Nur enumerierbare, eigene Eigenschaften verursachen, dass `propertyIsEnumerable()` `true` zurückgibt, obwohl alle enumerierbaren Eigenschaften, einschließlich geerbter, durch die [`for...in`](/de/docs/Web/JavaScript/Reference/Statements/for...in) Schleife besucht werden.
...
{{jsxref("Symbol")}}-Eigenschaften werden ebenfalls von `propertyIsEnumerable()` unterstützt. Beachten Sie, dass die meisten Enumerationsmethoden nur String-Eigenschaften besuchen; die Enumerierbarkeit von Symbol-Eigenschaften ist nur nützlich bei Verwendung von {{jsxref("Object.assign()")}} oder [Spread-Syntax](/de/docs/Web/JavaScript/Reference/Operators/Spread_syntax). Für mehr Informationen siehe [Enumerability and ownership of properties](/de/docs/Web/JavaScript/Enumerability_and_ownership_of_properties).
...
Alternativ können Sie {{jsxref("Object.getOwnPropertyDescriptor()")}} stattdessen verwenden, was auch hilft, zwischen nicht vorhandenen Eigenschaften und tatsächlich nicht enumerierbaren Eigenschaften zu unterscheiden.
