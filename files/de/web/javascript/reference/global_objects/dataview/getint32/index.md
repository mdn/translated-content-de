...
- `littleEndian` {{optional_inline}}
  - : Gibt an, ob die Daten im [Little- oder Big-Endian](/de/docs/Glossary/Endianness) Format gespeichert sind. Falls `false` oder `undefined`, wird ein Big-Endian-Wert gelesen.
