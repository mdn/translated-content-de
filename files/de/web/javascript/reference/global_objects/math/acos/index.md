...
Der Arkuskosinus (Winkel in Radiant zwischen 0 und π, inklusive) von `x`. Wenn `x` kleiner als -1 oder größer als 1 ist, wird {{jsxref("NaN")}} zurückgegeben.
