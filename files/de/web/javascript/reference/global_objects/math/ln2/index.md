...
Da `LN2` eine statische Eigenschaft von `Math` ist, wird sie immer als `Math.LN2` verwendet, anstatt als Eigenschaft eines von Ihnen erstellten `Math`-Objekts (`Math` ist kein Konstruktor).
