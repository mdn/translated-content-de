...
Da `LN2` eine statische Eigenschaft von `Math` ist, verwenden Sie sie stets als `Math.LN2` und nicht als Eigenschaft eines von Ihnen erstellten `Math`-Objekts (`Math` ist kein Konstruktor).
