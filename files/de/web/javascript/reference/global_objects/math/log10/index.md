...
Die **`Math.log10()`** statische Methode gibt den Logarithmus einer Zahl zur Basis 10 zurück. Das heißt
...
Der Logarithmus von `x` zur Basis 10. Wenn `x < 0` ist, wird {{jsxref("NaN")}} zurückgegeben.
