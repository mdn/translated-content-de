...
Da `asinh()` eine statische Methode von `Math` ist, verwenden Sie sie immer als `Math.asinh()` und nicht als Methode eines selbst erstellten `Math`-Objekts (`Math` ist kein Konstruktor).
