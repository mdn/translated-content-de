...
Der **`Int8Array()`** Konstruktor erstellt {{jsxref("Int8Array")}} Objekte. Die Inhalte sind auf `0` initialisiert, es sei denn, es werden explizit Initialisierungsdaten bereitgestellt.
