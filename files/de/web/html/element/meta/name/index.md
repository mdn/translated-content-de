  ...
  <table class="standard-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Den {{Glossary("origin", "origin")}} des Dokuments senden.</td>
      </tr>
      <tr>
...
- `viewport`: gibt Hinweise zur Größe der anfänglichen Größe des {{Glossary("viewport", "viewports")}}.
...
- `robots`: das Verhalten, das kooperative Crawler oder "Robots" mit der Seite verwenden sollten. Es ist eine durch Kommas getrennte Liste der unten aufgeführten Werte:
  ...
  > - Der Robot muss immer noch auf die Seite zugreifen, um diese Regeln zu lesen. Um Bandbreitenverbrauch zu verhindern, überlegen Sie, ob die Verwendung einer _{{Glossary("robots.txt", "robots.txt")}}_-Datei angemessener ist.
