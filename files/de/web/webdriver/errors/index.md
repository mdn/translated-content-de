...
| [no such cookie](/de/docs/Web/WebDriver/Errors/NoSuchCookie)                       | {{HTTPStatus(404, "404 Not Found")}}             | Kein Cookie, das mit dem angegebenen Pfadnamen übereinstimmt, wurde unter den [Cookies](/de/docs/Glossary/Cookie) des aktuellen [Dokuments](/de/docs/Web/API/Document) gefunden.                                                                                  |
