...
3. Zumindest anfänglich könnten Sie Ihren Code robuster machen, sodass er eine weniger personalisierte Erfahrung bietet, wenn Third-party-Cookie-Daten nicht verfügbar sind, anstatt sie vollständig zu brechen. Folgen Sie den Prinzipien der {{Glossary("Graceful_degradation", "graceful degradation")}}.
