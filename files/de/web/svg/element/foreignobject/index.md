...
Das **`<foreignObject>`** [SVG](/de/docs/Web/SVG) Element inkludiert Elemente aus einem anderen XML-Namensraum. Im Kontext eines Browsers ist es höchstwahrscheinlich (X)HTML.
