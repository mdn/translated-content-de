...
Das **`<circle>`** [SVG](/de/docs/Web/SVG)-Element ist eine [grundlegende SVG-Form](/de/docs/Web/SVG/Tutorial/Basic_Shapes), die verwendet wird, um Kreise basierend auf einem Mittelpunkt und einem Radius zu zeichnen.
...
- {{SVGAttr("r")}}
  - : Der Radius des Kreises. Ein Wert kleiner oder gleich null verhindert die Darstellung des Kreises.
    _Werttyp_: **[\<length>](/de/docs/Web/SVG/Content_type#length)**|**[\<percentage>](/de/docs/Web/SVG/Content_type#percentage)** ; _Standardwert_: `0`; _Animierbar_: **ja**
- {{SVGAttr("pathLength")}}
  - : Die Gesamtlänge für den Kreisumfang in Benutzereinheiten.
