...
> [!NOTE]
> Das `<tspan>`-Element wird standardmäßig nicht umbrochen. Um dies zu erreichen, muss es mit der {{CSSXRef("white-space")}}-CSS-Eigenschaft gestylt werden.
...
- {{SVGAttr("lengthAdjust")}}
  - : Wie der Text gestreckt oder komprimiert wird, um die durch das `textLength`-Attribut definierte Breite zu füllen.
