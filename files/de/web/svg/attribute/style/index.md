...
Das **`style`**-Attribut ermöglicht es, ein Element mit {{Glossary("CSS")}}-Deklarationen zu gestalten. Es funktioniert identisch wie [das `style`-Attribut in HTML](/de/docs/Web/HTML/Global_attributes/style).
