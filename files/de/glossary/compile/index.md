...
**Kompilieren** ist der Prozess der Umwandlung eines Computerprogramms, das in einer bestimmten [Sprache](/de/docs/Glossary/computer_programming) geschrieben wurde, in eine Menge von Anweisungen in einem anderen Format oder einer anderen Sprache. Ein **Compiler** ist ein Computerprogramm, das diese Aufgabe ausführt.
...
Der GNU `gcc` Compiler ist ein bekanntes Beispiel für einen AOT-Compiler. AOT-Compiler werden typischerweise von der Befehlszeile in einer Shell-Umgebung (über ein Terminal oder eine Konsole) oder innerhalb einer [IDE](/de/docs/Glossary/IDE) aufgerufen.
...
Compiler können auch zwischen höherstufigen Sprachen übersetzen – zum Beispiel von TypeScript zu [JavaScript](/de/docs/Glossary/JavaScript) – in diesem Fall werden sie oft als **Transpiler** bezeichnet.
