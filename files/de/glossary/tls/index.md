...
Alle modernen Browser unterstützen das TLS-Protokoll, wobei der Server ein gültiges [digitales Zertifikat](/de/docs/Glossary/Digital_certificate) bereitstellen muss, um seine Identität zu bestätigen und eine sichere Verbindung herzustellen. Es ist möglich, dass sich sowohl der Client als auch der Server gegenseitig authentifizieren, wenn beide Parteien ihre eigenen individuellen digitalen Zertifikate bereitstellen.
