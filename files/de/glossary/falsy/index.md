...
Ein **falsy**-Wert (manchmal auch **falsey** geschrieben) ist ein Wert, der in einem [Boolean](/de/docs/Glossary/Boolean)-Kontext als falsch angesehen wird.

[JavaScript](/de/docs/Glossary/JavaScript) verwendet [Typkonvertierung](/de/docs/Glossary/Type_Conversion), um jeden Wert in einen Boolean-Wert zu überführen, wenn dies in Kontexten erforderlich ist, wie beispielsweise [Kontrollstrukturen](/de/docs/Glossary/Conditional) und [Schleifen](/de/docs/Glossary/Loop).
...
Beispiele für _falsy_-Werte in JavaScript (die in Boolean-Kontexten zu false konvertiert werden und somit den `if`-Block _umgehen_):
