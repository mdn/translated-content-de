...
{{Glossary("ECMAScript", "ECMAScript")}} 5 und später erlauben es Skripten, in einen neuen [strict mode](/de/docs/Web/JavaScript/Reference/Strict_mode) zu wechseln, der die Semantik von JavaScript in mehreren Aspekten verändert, um dessen Belastbarkeit zu verbessern und das Verständnis des Geschehens bei Problemen zu erleichtern.
