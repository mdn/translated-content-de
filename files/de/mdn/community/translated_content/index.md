...
Seit dem 14. Dezember 2020 läuft MDN auf der neuen, GitHub-basierten [Yari-Plattform](https://github.com/mdn/yari). Dies bringt viele Vorteile für MDN, jedoch mussten wir grundlegende Änderungen in der Art und Weise vornehmen, wie wir die Lokalisierung handhaben. Der Grund dafür ist, dass wir viele ungewartete und veraltete Inhalte in unseren nicht-englischen Lokalisierungen haben und dies in Zukunft besser verwalten möchten.

Wir haben alle Lokalisierungen **außer** den unten aufgeführten archiviert, was bedeutet, dass sie auf GitHub nur lesbar sind und nicht auf MDN angezeigt werden können. Die aktiven Lokalisierungen haben dedizierte Teams, die die Verantwortung für deren Pflege übernehmen.

## Anleitung zum Mitwirken

Wenn Sie zu einer der bestehenden aktiven Lokalisierungen beitragen möchten, besuchen Sie das [mdn/translated-content GitHub-Repository](https://github.com/mdn/translated-content). Dieses Repository enthält alle lokalisierten Dokumente für alle aktiven Lokalisierungen sowie die Problemverfolgung. Wir empfehlen, zuerst den [Übersetzungsleitfaden](https://github.com/mdn/translated-content/tree/main/docs) zu lesen.

Wenn Sie Hilfe benötigen oder Fragen haben, können Sie sich gerne an eines der aktiven Mitglieder oder Communities wenden, die unten aufgeführt sind, oder [kontaktieren Sie uns](/de/docs/MDN/Community/Communication_channels).
...
- [MDN-Lokalisierungs-Update, Februar 2021](https://hacks.mozilla.org/2021/02/mdn-localization-update-february-2021/) — der neueste Stand der Lokalisierung auf MDN
- [Ein Update zur Lokalisierungsstrategie von MDN Web Docs](https://hacks.mozilla.org/2020/12/an-update-on-mdn-web-docs-localization-strategy/) — aktualisierte Strategie basierend auf Rückmeldungen der Community
- [MDN Web Docs entwickelt sich weiter! Details zur bevorstehenden neuen Plattform](https://hacks.mozilla.org/2020/10/mdn-web-docs-evolves-lowdown-on-the-upcoming-new-platform/) — mehr über die Vorteile der neuen Plattform und die Gründe für die Lokalisierungsänderungen
