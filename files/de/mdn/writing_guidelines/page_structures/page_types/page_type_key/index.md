---
title: Der page-type Front Matter Key
slug: MDN/Writing_guidelines/Page_structures/Page_types/Page_type_key
l10n:
  sourceCommit: e9b6cd1b7fa8612257b72b2a85a96dd7d45c0200
---

Der `page-type` Front Matter Key beschreibt den Typ einer MDN-Seite. Dies ermöglicht es den MDN-Inhaltstools, die Inhaltsprüfung und die Organisation der Seitenleiste besser zu automatisieren.
...
Jeder Hauptbereich der Website — JavaScript, CSS usw. — hat eine Reihe von fachbereichsspezifischen `page-type` Werten, und es gibt auch eine Reihe von generischen Werten, die in jedem Bereich der Website erscheinen können.
...
- `landing-page`: eine Übersicht über das Thema, eine Abschnittseinführung und die Navigation zu den wichtigsten Bereichen.
...
## Fachbereichsspezifische Seitentypen

Dieser Abschnitt listet Seitentypen auf, die spezifisch für einen Einzelbereich bei MDN sind.

### Lernbereich Seitentypen

Dieser Abschnitt listet `page-type` Werte für Seiten unter [Lernen](/de/docs/Learn_web_development) auf. Jede Seite in diesem Teil des Baums muss einen `page-type` haben, und sein Wert muss einer der unten aufgeführten oder einer der generischen Seitentypen sein.

- `learn-topic`: eine Übersicht über ein Thema, d.h. eine Sammlung von Modulen wie [_CSS_](/de/docs/Learn_web_development/Core/Styling_basics).
- `learn-module`: eine Übersicht über ein Modul, d.h. eine geordnete Sammlung von Leitfäden wie [_Inhalte mit HTML strukturieren_](/de/docs/Learn_web_development/Core/Structuring_content).
...
- `learn-module-assessment`: ein spezieller Leitfaden mit einer Aktivität, um das Verständnis eines Moduls oder eines Teils davon zu bewerten, wie [_Testen Sie Ihre Fähigkeiten: Grundlegende Steuerungen_](/de/docs/Learn_web_development/Extensions/Forms/Test_your_skills:_Basic_controls).
...
### Zugänglichkeit Seitentypen

Dieser Abschnitt listet `page-type` Werte für Seiten unter [Web/Zugänglichkeit](/de/docs/Web/Accessibility) auf. Jede Seite in diesem Teil des Baums muss einen `page-type` haben, und sein Wert muss einer der unten aufgeführten oder einer der [generischen Seitentypen](#generische_seitentypen) sein.
...
- `glossary-disambiguation`: eine Seite, die Links zu zwei oder mehr Definitionsseiten für einen mehrdeutigen Begriff bietet, wie {{Glossary("Node", "Knoten")}}.
...
- `web-api-overview`: gibt einen Überblick über ein Web-API, wie die [Fetch API](/de/docs/Web/API/Fetch_API).
...
- `webextension-manifest-key`: ein WebExtension-Manifesteintrag, wie [`user_scripts`](/de/docs/Mozilla/Add-ons/WebExtensions/manifest.json/user_scripts).
