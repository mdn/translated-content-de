---
title: Der `page-type` Schlüssel im Frontmatter
slug: MDN/Writing_guidelines/Page_structures/Page_types/Page_type_key
l10n:
  sourceCommit: a4fcf79b60471db6f148fa4ba36f2cdeafbbeb70
---

Der `page-type` Schlüssel im Frontmatter beschreibt den Typ einer MDN-Seite. Dies ermöglicht es MDN-Inhaltswerkzeugen, die automatisierte Inhaltsprüfung und die Organisation der Seitenleiste besser zu optimieren.

Wie jeder andere Schlüssel im Frontmatter wird der `page-type` Schlüssel im YAML am Anfang von "index.md" angegeben:
...
- `landing-page`: eine Übersicht über das Thema, Abschnittseinführung und Navigation zu wichtigen Bereichen.
...
- `learn-topic`: eine Übersicht über ein Thema, das eine Sammlung von Modulen ist, wie [_CSS_](/de/docs/Learn_web_development/Core/Styling_basics).
- `learn-module`: eine Übersicht über ein Modul, das eine geordnete Sammlung von Leitfäden ist, wie [_Structuring content with HTML_](/de/docs/Learn_web_development/Core/Structuring_content).
...
- `learn-module-assessment`: ein spezieller Leitfaden mit einer Aktivität, die es ermöglicht, die Verständlichkeit eines Moduls oder eines Teils davon zu bewerten, wie [_Test your skills: Forms and buttons_](/de/docs/Learn_web_development/Core/Structuring_content/Test_your_skills/Forms_and_buttons).
...
- `css-shorthand-property`: eine [Kurzschreibweise für Eigenschaften](/de/docs/Web/CSS/CSS_cascade/Shorthand_properties), wie {{cssxref("background")}}.
...
- `glossary-definition`: eine Seite, die einen Begriff definiert, wie {{Glossary("Bezier_curve", "Bézier curve")}}.
...
- `html-attribute-value`: ein Einzelwert für ein HTML-Attribut, wie [`dns-prefetch`](/de/docs/Web/HTML/Reference/Attributes/rel/dns-prefetch).
...
- `webdriver-command`: ein Webdriver-Kommando, wie [`CloseWindow`](/de/docs/Web/WebDriver/Reference/Commands/CloseWindow).
...
- `firefox-release-notes`: die Versionshinweise für eine bestimmte Firefox-Version, wie zum Beispiel [_Firefox 115 for developers_](/de/docs/Mozilla/Firefox/Releases/115).
