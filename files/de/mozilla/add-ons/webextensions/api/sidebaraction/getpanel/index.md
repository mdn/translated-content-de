...
- `details`
  ...
  - : `object`. Ein Objekt mit den folgenden Eigenschaften:
    ...
    - `tabId` {{optional_inline}}
      - : `integer`. Erhält das Panel für die Seitenleiste, die spezifisch für den angegebenen Tab ist.
    - `windowId` {{optional_inline}}
      - : `integer`. Erhält das Panel für die Seitenleiste, die spezifisch für das angegebene Fenster ist.
...
Ein [`Promise`](/de/docs/Web/JavaScript/Reference/Global_Objects/Promise), das mit einem String erfüllt wird, der die URL für das Dokument des Panels enthält. Dies wird eine vollständig qualifizierte URL sein, wie:
...
Erhalten Sie die URL des Panels:
