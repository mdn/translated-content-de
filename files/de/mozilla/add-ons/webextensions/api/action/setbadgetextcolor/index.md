...
Setzt die Textfarbe für das Badge der Browseraktion. Tabs, die keine spezifische Badge-Textfarbe haben, erben die globale Badge-Textfarbe.
...
Eine Badge-Textfarbe, die anfängt als Rot und grün wird, wenn die Browseraktion angeklickt wird:
...
> [!NOTE]
> Diese API basiert auf der [`chrome.action`](https://developer.chrome.com/docs/extensions/reference/api/action#method-setBadgeBackgroundColor) API von Chromium. Diese Dokumentation stammt von [`browser_action.json`](https://chromium.googlesource.com/chromium/src/+/master/chrome/common/extensions/api/browser_action.json) im Chromium-Code.
