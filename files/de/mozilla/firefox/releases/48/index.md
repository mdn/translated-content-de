...
- Der `text` Wert von {{cssxref("background-clip")}} ist jetzt in allen Versionen von Firefox verfügbar (und nicht nur in Nicht-Release-Versionen) ([Firefox Bug 1263516](https://bugzil.la/1263516)).
