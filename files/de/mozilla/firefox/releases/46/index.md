...
- Im [Strikten Modus](/de/docs/Web/JavaScript/Reference/Strict_mode) wird das Setzen von Eigenschaften auf {{Glossary("primitive", "primitiven")}} Werten jetzt einen {{jsxref("TypeError")}} auslösen ([Firefox Fehler 603201](https://bugzil.la/603201)).
