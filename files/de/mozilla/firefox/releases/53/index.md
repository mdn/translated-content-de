...
- {{Glossary("DTMF", "DTMF")}}-Unterstützung ist nun standardmäßig mit [`RTCDTMFSender`](/de/docs/Web/API/RTCDTMFSender) aktiviert. Siehe [Using DTMF with WebRTC](/de/docs/Web/API/WebRTC_API/Using_DTMF) für weitere Informationen, wie dies funktioniert.
