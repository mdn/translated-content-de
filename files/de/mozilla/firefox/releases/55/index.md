...
- Die [Intersection Observer API](/de/docs/Web/API/Intersection_Observer_API) — die eine Möglichkeit bietet, Änderungen der Schnittmenge eines Ziel-Elements mit einem Vorfahren-Element oder mit dem [Viewport](/de/docs/Glossary/Viewport) eines obersten Dokuments asynchron zu beobachten — wurde hinzugefügt ([Firefox-Bug 1321865](https://bugzil.la/1321865)).
