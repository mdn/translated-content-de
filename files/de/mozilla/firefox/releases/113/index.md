...
- Die Syntax [`:nth-child of <selector>`](/de/docs/Web/CSS/Reference/Selectors/:nth-child#the_of_selector_syntax) ermöglicht es, eine Gruppe von Kinderelementen basierend auf der `An+B`-Regel zu selektieren, die auch einem definierten Selektor entspricht. Weitere Details finden Sie unter ([Firefox Bug 1808229](https://bugzil.la/1808229)).
