...
Willkommen im MDN-Lernbereich. Diese Reihe von Artikeln soll Anfängern in der Webentwicklung grundlegende Fähigkeiten zum Codieren von Websites vermitteln. Ziel ist es nicht, Sie von "Anfänger" zu "Experte" zu machen, sondern von "Anfänger" zu "wohlfühlend". Von dort aus sollten Sie in der Lage sein, Ihren eigenen Weg zu gehen, indem Sie von [dem Rest von MDN](/en-US/) und anderen mittleren bis fortgeschrittenen Ressourcen lernen, die viel Vorwissen voraussetzen.
...
Wenn Sie sich nicht sicher sind, ob Sie sich tiefgehend mit der Webentwicklung befassen möchten und mit einer Kostprobe beginnen möchten, empfehlen wir, dass Sie mit unseren [Erste Schritte im Web](/de/docs/Learn/Getting_started_with_the_web) Leitfäden beginnen. Darüber hinaus sollten Sie mit dem Lernen der folgenden Themen beginnen:

- HTML und CSS
  - : HTML bietet Struktur für Webinhalte, während CSS Anweisungen gibt, wie dieser Inhalt gestylt und angeordnet wird. Siehe [Einführung in HTML](/de/docs/Learn/HTML/Introduction_to_HTML) und [CSS: Erste Schritte](/de/docs/Learn/CSS/First_steps) für wichtige Starterinformationen.
- JavaScript
  - : JavaScript ermöglicht Ihnen, interaktive Funktionalitäten auf Websites zu programmieren. Beginnen Sie mit [JavaScript: Erste Schritte](/de/docs/Learn/JavaScript/First_steps).
- Frameworks und Werkzeuge
  - : Nachdem Sie die Grundlagen von reinem HTML, CSS und JavaScript gemeistert haben, sollten Sie mehr über [clientseitige Webentwicklungswerkzeuge](/de/docs/Learn/Tools_and_testing/Understanding_client-side_tools) lernen und dann überlegen, sich mit [clientseitigen JavaScript-Frameworks](/de/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks) zu befassen. Zudem sollten Sie die grundlegenden Konzepte des [serverseitigen Website-Programmings](/de/docs/Learn/Server-side) lernen.

> [!NOTE]
> Unser [Glossar](/de/docs/Glossary) bietet Definitionen von Fachbegriffen. Wenn Sie außerdem eine spezifische Frage zur Webentwicklung haben, finden Sie möglicherweise in unserem Abschnitt [Häufige Fragen](/de/docs/Learn/Common_questions) etwas Hilfreiches.

> [!CALLOUT]
>
> **Möchten Sie ein Frontend-Webentwickler werden?**
>
> Wenn Sie Frontend-Webentwickler werden möchten und sich nicht sicher sind, was Sie zuerst lernen sollen, empfehlen wir, den [MDN-Lehrplan](/en-US/curriculum/) zu nutzen, um Ihr Lernen zu planen. Er bietet einen strukturierten Lernweg, der die wesentlichen Fähigkeiten und Praktiken abdeckt, die für einen erfolgreichen Frontend-Entwickler notwendig sind, zusammen mit empfohlenen Lernressourcen.
>
> [**Jetzt starten**](/en-US/curriculum/)
...
- [HTML — Das Web strukturieren](/de/docs/Learn/HTML)
...
- [CSS — Das Web gestalten](/de/docs/Learn/CSS)
...
- [JavaScript — Dynamisches clientseitiges Skripting](/de/docs/Learn/JavaScript)
...
- [Web Performance — Websites schnell und reaktionsschnell machen](/de/docs/Learn/Performance)
...
> [!NOTE]
> Die meisten Bewertungsanleitungen und anderen Ressourcen für die Aufgaben und Bewertungen sind in [`mdn/learning-area`](https://github.com/mdn/learning-area/) verfügbar, obwohl einige in [`mdn/css-examples`](https://github.com/mdn/css-examples/tree/main/learn) sind.
...
Wenn Sie sie alle auf Ihren Computer kopieren möchten, ist der einfachste Weg, [ein ZIP der neuesten Haupt-Codezweigs herunterzuladen](https://codeload.github.com/mdn/learning-area/zip/main).
...
1. [Installieren Sie Git](https://git-scm.com/downloads) auf Ihrem Rechner. Dies ist die zugrunde liegende Versionskontrollsystem-Software, auf der GitHub aufbaut.
2. Öffnen Sie die [Eingabeaufforderung](https://www.lifewire.com/how-to-open-command-prompt-2618089) (Windows) oder das Terminal ([Linux](https://help.ubuntu.com/community/UsingTheTerminal), [macOS](https://blog.teamtreehouse.com/introduction-to-the-mac-os-x-command-line)) Ihres Computers.
3. Um das Lernbereichs-Repo in einen Ordner namens learning-area an dem aktuellen Ort, auf den Ihre Eingabeaufforderung/Terminal zeigt, zu kopieren, verwenden Sie den folgenden Befehl:

   ```bash
   git clone https://github.com/mdn/learning-area
   ```

4. Sie können nun das Verzeichnis betreten und die Dateien finden, die Sie suchen (entweder mit Ihrem Finder/Dateiexplorer oder dem [`cd`-Befehl](<https://en.wikipedia.org/wiki/Cd_(command)>)).

Sie können das `learning-area`-Repository mit den folgenden Schritten mit allen Änderungen, die an der Hauptversion auf GitHub vorgenommen wurden, aktualisieren:

1. Gehen Sie in Ihrer Eingabeaufforderung/Ihrem Terminal mit `cd` in das `learning-area`-Verzeichnis. Zum Beispiel, wenn Sie sich im übergeordneten Verzeichnis befanden:
...
Wenn Sie daran interessiert sind, Inhalte zu entwickeln/verbessern, schauen Sie sich an, [wie Sie helfen können](/de/docs/MDN/Community/Contributing) und treten Sie mit uns in Kontakt! Wir sprechen mehr als gerne mit Ihnen, egal ob Sie Lernender, Lehrer, erfahrener Webentwickler oder jemand anderes sind, der daran interessiert ist, das Lernerlebnis zu verbessern.

## Siehe auch

- [Der Karriereweg zum Frontend-Entwickler](https://v2.scrimba.com/the-frontend-developer-career-path-c0j?via=mdn) <sup>_MDN-Lehrplanpartner_</sup>
