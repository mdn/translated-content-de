...
Die im vorherigen Abschnitt beschriebenen Codecs existieren, um Video und Audio in handhabbare Dateien zu komprimieren, da rohe Audio- und Videodateien beide außerordentlich groß sind. Jeder Webbrowser unterstützt eine Reihe von **{{Glossary("Codec", "Codecs")}}**, wie Vorbis oder H.264, die verwendet werden, um die komprimierten Audio- und Videodaten in Binärdaten umzuwandeln und zurück. Jeder Codec bietet seine eigenen Vor- und Nachteile, und jeder Container kann ebenfalls seine eigenen positiven und negativen Merkmale haben, die Ihre Entscheidungen über welche zu verwenden beeinflussen.
...
> [!NOTE]
> Texttracks helfen Ihnen auch bei {{Glossary("SEO", "SEO")}}, da Suchmaschinen besonders auf Text gedeihen. Texttracks ermöglichen es Suchmaschinen sogar, direkt auf eine Stelle im Video zu verlinken.
