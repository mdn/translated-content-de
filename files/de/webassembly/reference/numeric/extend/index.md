...
Die **`extend`**-Anweisungen werden verwendet, um Zahlen des Typs `i32` in den Typ `i64` zu konvertieren (erweitern). Es gibt sowohl signierte als auch unsignierte Versionen dieser Anweisung.
