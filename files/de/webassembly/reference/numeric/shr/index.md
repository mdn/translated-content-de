---
title: "shr: Wasm Text-Instruktion"
short-title: shr
...
Die **`shr`**-Instruktionen, kurz für _shift-right_, werden verwendet, um eine bitweise Rechtsverschiebung durchzuführen, ähnlich dem **`>>>`**-Operator in anderen Sprachen.
