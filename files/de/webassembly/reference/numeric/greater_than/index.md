...
Die **`gt`**-Instruktionen, abgeleitet von _greater than_, prüfen, ob eine Zahl größer als eine andere Zahl ist. Wenn die erste Zahl größer als die zweite ist, wird `1` auf den Stapel geschoben, andernfalls wird `0` auf den Stapel geschoben.
